...
const Storage = multer.diskStorage({
    destination(req, file, callback) { 
        ...
        //yha nhi aara
      callback(null, '/home/com115/Desktop/react-native/posts')
    },
...
//   yeh in uploadpost wala console dikha
...
router.post("/addCategory",upload.single("fileData"),function(req,res){
    
    console.log("in addCategroy^^^^^^^^",req.body);
